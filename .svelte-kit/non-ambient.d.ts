...
declare module "$app/types" {
	...
	export interface AppTypes {
		RouteId(): "/" | "/api" | "/api/login" | "/api/logout" | "/api/note" | "/api/register" | "/login" | "/profile" | "/register";
		RouteParams(): {
		...
		Pathname(): "/" | "/api/login" | "/api/logout" | "/api/note" | "/api/register" | "/login" | "/profile" | "/register";
