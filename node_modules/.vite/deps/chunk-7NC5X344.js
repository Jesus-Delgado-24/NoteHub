...
function assign(object, property, rhs_getter, location) {
  return compare(
...
function assign_and(object, property, rhs_getter, location) {
  return compare(
    object[property] &&= rhs_getter(),
    untrack(() => object[property]),
    property,
...
function assign_or(object, property, rhs_getter, location) {
  return compare(
    object[property] ||= rhs_getter(),
    untrack(() => object[property]),
    property,
...
function assign_nullish(object, property, rhs_getter, location) {
  return compare(
    object[property] ??= rhs_getter(),
    untrack(() => object[property]),
    property,
...
//# sourceMappingURL=chunk-7NC5X344.js.map
